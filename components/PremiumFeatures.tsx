...
const PremiumFeatures: React.FC<PremiumFeaturesProps> = ({
  title = '프리미엄 기능 소개',
  description = '더 강력한 분석과 인사이트를 제공하는 프리미엄 기능을 확인하세요.',
  features = defaultFeatures,
  ctaText = '프리미엄 시작하기',
  ctaLink = '/pricing'
}) => {
  return (
    <section className="my-12 rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 px-6 py-8 shadow-sm">
      ...
      <div className="mt-8 text-center">
        <Link
          href={ctaLink}
          className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-5 py-3 text-base font-medium text-white shadow-sm transition-colors hover:bg-blue-700"
        >
          {ctaText}
        </Link>
      </div>
