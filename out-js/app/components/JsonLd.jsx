...
var JsonLd = function (_a) {
    var data = _a.data;
    return (<Script id="json-ld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(data) }} strategy="beforeInteractive"/>);
};
export default JsonLd;
// FAQ 타입 구조화 데이터 생성기
export function createFaqJsonLd(questions) {
    return {
        '@context': 'https://schema.org',
        '@type': 'FAQPage',
        mainEntity: questions.map(function (q) { return ({
            '@type': 'Question',
            name: q.question,
            acceptedAnswer: {
                '@type': 'Answer',
