    ...
    return (<div className="card overflow-x-auto">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          <button className={"px-4 py-2 text-sm font-medium rounded-md min-w-[140px] ".concat(activeTab === 'analysis'
            ? 'bg-blue-500 text-white'
            : 'bg-gray-200 text-gray-700 hover:bg-gray-300')} onClick={function () { return setActiveTab('analysis'); }}>
            키워드 분석 결과
          </button>
          <button className={"px-4 py-2 text-sm font-medium rounded-md min-w-[140px] ".concat(activeTab === 'trending'
            ? 'bg-blue-500 text-white'
