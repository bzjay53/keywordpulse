...
function useClipboard(options) {
    ...
    var _a = options.timeout, timeout = _a === void 0 ? 2000 : _a, onSuccess = options.onSuccess, onError = options.onError;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    console.error('클립보드 복사 실패:', error_1);
                    return [3 /*break*/, 5];
    ...
    return { value: value, status: status, copy: copy, isIdle: status === 'idle', isCopied: status === 'copied', isError: status === 'error' };
}
